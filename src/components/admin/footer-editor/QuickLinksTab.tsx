          ...
          {quickLinks.map((link) => (
            <div key={link.id} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border border-gray-200 rounded-md relative">
              <div className="space-y-2">
                <Label htmlFor={`link-label-${link.id}`}>{t('linkLabelEn')}</Label>
                <Input 
              ...
              <div className="space-y-2">
                <Label htmlFor={`link-label-ar-${link.id}`}>{t('linkLabelAr')}</Label>
                <Input 
              ...
              <div className="space-y-2">
                <Label htmlFor={`link-url-${link.id}`}>{t('linkURL')}</Label>
                <Input 
                  id={`link-url-${link.id}`}
                  value={link.url}
