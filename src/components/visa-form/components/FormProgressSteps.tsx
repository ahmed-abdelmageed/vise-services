...
export const FormProgressSteps = ({ formStep, serviceTitle = "" }: FormProgressStepsProps) => {
    ...
    <div className="mb-4 sm:mb-6">
      <div className="flex justify-between mb-1 sm:mb-2">
        {steps.map(({ step, label }) => (
          <div 
            key={step} 
            className={`flex flex-col items-center space-y-0 sm:space-y-1 ${step <= formStep ? "text-visa-gold" : "text-gray-400"}`}
          >
            <div className={`
