  ...
  useEffect(() => {
    if (service) {
      ...
      form.reset({
        ...
        idFilesRequired: service.idFilesRequired ?? false,
        salaryProofRequired: service.salaryProofRequired ?? false,
        photoFilesRequired: service.photoFilesRequired ?? false,
        passportFilesRequired: service.passportFilesRequired ?? false,
