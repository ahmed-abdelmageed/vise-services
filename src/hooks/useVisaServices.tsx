...
export const useVisaServices = (onDataChanged?: () => Promise<void>) => {
  ...
  const visaServices: VisaConfig[] = visaServicesData?.map(item => ({
    ...
    idFilesRequired: item.id_files_required || false,
    salaryProofRequired: item.salary_proof_required || false,
    photoFilesRequired: item.photo_files_required || false,
    passportFilesRequired: item.passport_files_required || false,
  ...
  const handleDragEnd = async (event: DragEndEvent) => {
    ...
    try {
      ...
      const optimisticData = reorderedServices.map(item => ({
        ...
        id_files_required: item.idFilesRequired,
        salary_proof_required: item.salaryProofRequired,
        photo_files_required: item.photoFilesRequired,
        passport_files_required: item.passportFilesRequired,
        usavisacities: item.usaVisaCities,
